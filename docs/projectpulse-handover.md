...
33. ~~In-talks (pipeline) projects, BOM-based margin estimate before an order is won~~ — done, see Section 68 (migration 0028). Visibility rule captured as a concrete requirement for item 4 below, not built yet — needs real RLS.
